...
const path = __webpack_require__(622)
const Header = __webpack_require__(893)
...
const fs = __webpack_require__(747)
const fsm = __webpack_require__(732)
const t = __webpack_require__(845)
const path = __webpack_require__(622)
...
const fsm = __webpack_require__(732)
const path = __webpack_require__(622)
const mkdir = __webpack_require__(982)
...
exports.t = exports.list = __webpack_require__(845)
...
exports.Header = __webpack_require__(893)
...
async function startDevServer(opts) {
    ...
    const tmp = path_1.join(devCacheDir, 'go', Math.random()
        .toString(32)
        .substring(2));
...
Learn more: https://vercel.com/docs/runtimes#official-runtimes/go`);
    ...
    child.once('exit', async () => {
        await fs_extra_1.remove(tmp); // Cleanup
    });
    ...
    if (isPortInfo(result)) {
        ...
        throw new Error(`Failed to start dev server for "${entrypointWithExt}" (code=${result[0]}, signal=${result[1]})`);
    }
}
